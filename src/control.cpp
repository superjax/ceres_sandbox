...
//  double xf[2] = {1, 0};
  ...
  Vector2d x0 = x_desired.col(0);
  Vector2d xf = x_desired.col(1);
  ...
  // pin final pose (constraint)
  problem.AddResidualBlock(new PositionVelocityConstraint1DFactor(new PositionVelocityConstraint1D(xf[0], x0[1])), NULL, x.data()+2*(K-1));
  x.col(K-1) << xf[0], v_init;
